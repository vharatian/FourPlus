...
public class WebSocketHandshake {
    ...
    public byte[] getHandshake(String connectivityInstanceId, String token) {
        return getHandshake(connectivityInstanceId, token, null);
    }
    public byte[] getHandshake(String connectivityInstanceId, String token, String realtimeChallengeId) {
        ...
        header.put("X-Backtory-Connectivity-Id", connectivityInstanceId);
        header.put("Authorization", "Bearer " + token);
        if (realtimeChallengeId != null) {
            header.put("X-Backtory-Realtime-Challenge-Id", realtimeChallengeId);
        }
